...
static void print_cinema_logo() {
    ...
    if (!logo_shown) {
        enable_ansi_colors(); 
        typewrite(RED,
            "   ___  _  _  _  _  ___  ___  _____  __   ____  \n", 6000);
        typewrite(RED,
            "  / __|| || \\| || || __||_ _||_   _|/  \\ |  _ \\ \n", 6000);
        typewrite(YELLOW,
            " | /   | || \\  || || _|  | |   | | / /\\ \\| |_) |\n", 6000);
...
void show_manager_actions_menu() {
    ...
    printf(CYAN   "  +========================================+\n" RESET);
    printf(CYAN   "  |" GREEN "  1  " WHITE "| Quan ly Phim                     " CYAN "|\n" RESET);
    printf(CYAN   "  |" GREEN "  2  " WHITE "| Chinh sua Phim                   " CYAN "|\n" RESET);
    printf(CYAN   "  |" GREEN "  3  " WHITE "| Xoa Phim                         " CYAN "|\n" RESET);
    printf(CYAN   "  |" GREEN "  4  " WHITE "| Xem Lich Chieu                   " CYAN "|\n" RESET);
    printf(CYAN   "  |" GREEN "  5  " WHITE "| Tao Suat Chieu Moi               " CYAN "|\n" RESET);
    printf(CYAN   "  |" GREEN "  6  " WHITE "| Huy Suat Chieu                   " CYAN "|\n" RESET);
    printf(CYAN   "  |" GREEN "  7  " WHITE "| Bao Cao Doanh Thu                " CYAN "|\n" RESET);
    printf(CYAN   "  +----------------------------------------+\n" RESET);
...
void show_customer_actions_menu() {
    ...
    printf(CYAN   "  +----------------------------------------+\n" RESET);
    printf(CYAN   "  |" RED   "  7  " WHITE "| Dang Xuat                        " CYAN "|\n" RESET);
    printf(CYAN   "  +========================================+\n" RESET);
    printf(YELLOW "\n  >> Nhap lua chon cua ban: " RESET);
}
